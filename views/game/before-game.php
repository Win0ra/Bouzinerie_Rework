...
<head>
    ...
    <link rel="stylesheet" href="/bouzinerie_rework/public/css/styles-bfr-game.css" type="text/css" media="all">
...
<body>
    <div class="content">
        ...
        <div class="back-button">
            <a href="./index.php"><button class="back"><i class="fa-solid fa-angle-left"></i>
        ...
        <div class="right-and-left">
            <div class="left">
                ...
                <a href="#"><button class="back link"><i class="fa-solid fa-link"></i>
            ...
            <div class="right">
                ...
                <a href="#" class="btn-right"><button class="back start-quiz"><i class="fa-solid fa-play"></i>
